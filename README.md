...
> 1. run `git clone https://github.com/erezfree29/events_brite/`
> 2. run `cd events_brite`
...
Feel free to check the [issues](https://github.com/erezfree29/events_brite/issues)
